        ...
        <div className={styles.contentWrapper}>
          ...
          <div className={styles.textWrapper}>
            ...
            <p className={styles.text}>
              UI/UX design is the process of creating intuitive and aesthetically pleasing user interfaces, ensuring seamless user experiences. It involves <span className={styles.highlight}>user research</span>, <span className={styles.highlight} >wireframing</span>, <span className={styles.highlight} >prototyping</span>, and <span className={styles.highlight}>testing</span> to deliver digital products that are both functional and visually appealing. The goal of UI/UX design is to understand the user’s needs and behaviors, then craft designs that provide solutions that are easy to navigate and delightful to interact with. It's a combination of creativity, psychology, and technology to make products user-centric and accessible across platforms like <span className={styles.highlight} >websites</span>, <span className={styles.highlight}>mobile apps</span>, and <span className={styles.highlight} >software</span>.</p>
